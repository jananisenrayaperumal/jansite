...
const Header = () => {
	...
	return (
		<header className="w-full pl-20 lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:flex-col lg:justify-between lg:py-24">
			<div>
				<h1 className="text-2xl font-bold tracking-tight text-slate-200 sm:text-5xl">
					<a href="/">Janani Senrayaperumal</a> <br />
				</h1>
				...
				<li className="mr-5 shrink-0 text-xs">
					<a
						...
						<svg
							...
							className="h-6 w-6"
							aria-hidden="true">
							{" "}// Adjust the size as needed (h-6 w-6 works well)
